    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const totalSalesResponse = await fetch('http://localhost:5000/api/admin/total-sales', {
                    method: "GET",
                    headers: {
                ...
                const todaySalesResponse = await fetch('http://localhost:5000/api/admin/today-sales', {
                    method: "GET",
                    headers: {
                        Authorization: authorizationToken,
                    }
                ...
                const lastMonthUserResponse = await fetch('http://localhost:5000/api/admin/last-month-user-data', {
                    method: "GET",
                    headers: {
                        Authorization: authorizationToken,
                    }
                ...
                const topUsersByProductResponse = await fetch('http://localhost:5000/api/admin/top-user-data', {
                    method: "GET",
                    headers: {
                        Authorization: authorizationToken,
                    }
        ...
        const tableRows = topUsersByProduct.map((product, index) => (
            <tr key={index}>
                <td style={{ border: '1px solid #dddddd', padding: '8px' }}>
                    <img src={`http://localhost:5000/${product.productImg}`} alt={`${product.productName}`} style={{ width: '150px', height: "auto", borderRadius: '8px' }} />
                </td>
