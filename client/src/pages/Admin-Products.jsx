...
export const AdminProducts = () => {
    ...
    const deleteProduct = async (id) => {
        try {
            const response_delete = await fetch(`http://localhost:5000/api/admin/products/delete/${id}`, {
                method: "DELETE",
                headers: {
                    Authorization: authorizationToken,
                },
            ...
            <div className="con">
                <div className="main">
                    ...
                    <div className="submain">
                        ...
                        <button style={{ marginLeft: "20px" }}><Link to="/admin/products/add" style={{ color: "#fff" }}>Add Product</Link></button>
                    </div>
                        ...
                        currentItems.map((curData, index) => {
                                return (
                                    <div className="product-box" key={curData._id}>
                                        <img src={`http://localhost:5000/${curData.productImg}`} alt="Product Image" style={{ zIndex: "0" }} />
                                        <div className="product-info">
                                            ...
                                            <div className="details">
                                                <p>Packing: {curData.packing.join(', ')}</p>
                                                <p>Shelf Life: {curData.shelfLife}</p>
                                            </div>
                                            <div className="details">
                                                <p>Price: {curData.price} Rs.</p>
                                                <p>Composition: {curData.composition}% fat</p>
                                            </div>
                                            <div className="details">
                                                <p>Storage Condition: {curData.storageCondition}</p>
                                            </div>
                                            <div className="details">
                                        ...
                                        <div className="buttons">
                                            <Link className="but" to={`/admin/products/${curData._id}/edit`} style={{ marginBottom: "10px" }}>Edit</Link>
