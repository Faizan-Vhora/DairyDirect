...
export const AdminTodayUpdatesUpdate = () => {
    ...
    const getSingleTodayUpdatesData = async() => {
        try {
            const response = await fetch(`http://localhost:5000/api/admin/today-updates/${params.id}`,{
                method: "GET",
                headers: {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            const response = await fetch(`http://localhost:5000/api/admin/today-updates/update/${params.id}`,{
                method: "PATCH",
                headers: {
