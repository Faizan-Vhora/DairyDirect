...
module.exports = {
  addCategorys, addProducts, addTodayUpdates,
  getAllUsers, getAllContacts, getAllProducts, getAllCategory, getAllVendors, getAllTodayUpdates, getAllOrders,
  getLastTodayUpdates,
  getUsersById, getProductById, getCategorysById, getVendorsById, getTodayUpdatesById,
  updateUserById, updateProductById, updateCategoryById, updateTodayUpdatesById,
  deleteUserById, deleteContactById, deleteProductById, deleteCategoryById, deleteVendorById, deleteTodayUpdatesById,
  confirmVendorsById, rejectVendorsById,
  getTotalSalesByProduct, getTodaySalesByProduct, getTopUsersByProductLastMonth, getTopUsersForAllProducts
};